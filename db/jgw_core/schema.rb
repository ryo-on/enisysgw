...
ActiveRecord::Schema.define(:version => 20140313114000) do
  ...
  create_table "system_role_groups", :force => true do |t|
  ...
  add_index "system_role_groups", ["system_role_id"], :name => "index_system_role_groups_on_system_role_id"
  ...
  create_table "system_users_groups_csvdata_profiles", :force => true do |t|
    t.integer  "user_id"
    t.string   "user_code"
    t.text     "add_column1"
    t.text     "add_column2"
  ...
  create_table "system_users_profile_images", :force => true do |t|
    t.integer  "user_id"
    t.string   "user_code"
    t.string   "note"
    t.string   "path"
  ...
  create_table "system_users_profile_settings", :force => true do |t|
    t.string   "key_name"
    t.string   "name"
    t.integer  "used"
    t.datetime "created_at", :null => false
  ...
  create_table "system_users_profiles", :force => true do |t|
    t.integer  "user_id"
    t.string   "user_code"
    t.text     "add_column1"
    t.text     "add_column2"
