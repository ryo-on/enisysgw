...
class Gw::Admin::PrefConfigsController < Gw::Controller::Admin::Base
  ...
  def init_params
    ...
    if @mode == "pref_executives"
      @ret = "executive"
      Page.title = @page_title = I18n.t("rumi.config_settings.scheduler.pref_executive.page_title")
      @role_developer  = Gw::PrefExecutive.is_dev?
      @role_admin      = Gw::PrefExecutive.is_admin?
    else
      @ret = "director"
      Page.title = @page_title = I18n.t("rumi.config_settings.scheduler.pref_director.page_title")
