...
class Gw::Admin::PrefExecutiveAdminsController < Gw::Controller::Admin::Base
  ...
  def initialize_scaffold
    ...
    Page.title = I18n.t("rumi.config_settings.scheduler.pref_executive.page_title")
  end
  ...
  def csvput
    ...
    case par_item[:csv]
    when 'put'
      filename = "shicho_fukushicho_zaicho_#{par_item[:nkf]}_#{Time.now.strftime('%Y%m%d_%H%M')}.csv"
