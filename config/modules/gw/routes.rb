...
EnisysGw::Application.routes.draw do
  ...
  match '/api/header_menus' => 'gw/admin/piece/api#header_menus'
  match '/api/mail_admin' => 'gw/admin/piece/api#mail_admin'
  ...
  namespace mod do
    scope :module => scp do
      ...
      resources :schedule_props do
        collection do
          get :show_week, :show_month, :setting, :setting_system, :setting_ind, :getajax, :show_guard, :schedule_display
        end
        member do
          get :show_one
        end
    ...
    namespace mod do
      scope :module => scp do
        resources :link_sso, :constraints => {:id  => /[0-9]+/}  do
          ...
          member do
            get :redirect_pref_soumu, :redirect_pref_cms, :redirect_pref_pieces, :redirect_to_dcn, :redirect_rumi_mail
          end
        end
      end
    end
